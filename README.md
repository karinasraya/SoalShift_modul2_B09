...
0. buat sebuah proccess daemon dengan isi while(1) sebagai berikut : [Script Soal 4](/soal4/soal4.c)
...
Penjelasan : 
start_t merupakan variabel penanda program dimulai. Coutn merupakan variabel penghitung untuk log.
...
Penjelasan : 
syntax di dalam if sama dengan syntax di atas while dan syntax itu dijalankan ketika selisih dari detik mulai dan detik saat ini 1800 (30 menit). Di dalam if, waktu mulai dan penanda log akan direstart kembali menjadi 0.
...
3. Untuk mematikan proses 5a gunakan syntax berikut
